...
{
	int ret = 0;
#ifdef ZCFG_TF_SET_VDDSDCORE_VOL
	if(strstr(rdev_get_name(regulator->rdev), "vddsdcore")){
		min_uV = ZCFG_TF_SET_VDDSDCORE_VOL*1000;
		max_uV = ZCFG_TF_SET_VDDSDCORE_VOL*1000;
	}
#endif
