...
#define VENDOR_PSC54X5A					(0x7)

#ifdef VENDOR_PSC54X5A
#define VENDOR_ID2_PSC5415A					(0x5)
#define VENDOR_ID2_PSC5425A					(0x6)
#endif
...
extern unsigned char fan54015_get_vendor_id2(void);
