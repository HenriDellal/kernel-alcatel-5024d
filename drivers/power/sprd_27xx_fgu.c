...
extern int s_cur_cnom,s_cur_rint,s_cur_track_status;
...
int sprdfgu_read_soc(void)
{
	...
	SPRD_FGU_DEBUG("d cap %d,cnom %d,g %dmAh(0.1mA),init_cc:%d\n",
		...
		s_cur_cnom=sprdfgu_data.cur_cnom;
		s_cur_rint=sprdfgu_data.cur_rint;
		s_cur_track_status=sprdfgu_data.qmax.state;
