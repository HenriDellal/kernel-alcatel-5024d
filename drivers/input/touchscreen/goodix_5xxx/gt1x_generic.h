...
#if defined(ZCFG_TP_GT5XX_FW_IN_ZYT_H)
...
#if defined(ZCFG_TP_GT5XX_FW_IN_ZYT_H)
#define GTP_CFG_GROUP0	ZCFG_TP_GT5XX_FW_IN_ZYT_H
#else
...
#define GTP_KEY_TAB	 {KEY_APPSELECT, KEY_HOMEPAGE, KEY_BACK, KEY_SEARCH}
...
//Log define
#undef GTP_INFO_LOG_ON
#ifdef GTP_INFO_LOG_ON
...
extern int Gt5xx_remove_ctp_chip(void);
#if TOUCH_VIRTUAL_KEYS
extern void Gt5xx_virtual_keys_destroy(void);
#endif
